...
let phoneNumberInput = document.querySelector(".main-register-info-phoneNumber-input")
let phoneNumberValidation = document.querySelector(".main-register-info-phoneNumber-validation")
...
form.addEventListener("keyup", (event)=>{
    if(validateEmail(emailInput.value) && validePhoneNumber(phoneNumberInput.value)){
